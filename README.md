...
![Metro](https://github.com/user-attachments/assets/48e4e3fd-ac1e-4a05-8da4-8e2e13262eb7)<svg width="600" height="76.6" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" enable-background="new 0 0 600 76.6" version="1.1" xml:space="preserve">
  <style type="text/css">
    <style type="text/css">
.st0{fill:none;stroke:#F0F0F0;stroke-miterlimit:10;}
.st1{fill:none;stroke:#F0F0F0;stroke-width:0.93;stroke-miterlimit:10;}
.st2{fill:#6600ff;}  /* Bright red for text */
.st3{fill:#ff0000;}  /* Darker red for metro body */
.st4{fill:#ff1a1a;}  /* White */
.st5{fill:#668cff;}  /* Light red highlights */
.st6{fill:none;stroke:#66ffff;stroke-width:1.8074;stroke-miterlimit:10;}  /* Pink-red stroke */
.st7{fill:none;stroke:#66ffff;stroke-width:0.794;stroke-miterlimit:10;}  /* Dark red stroke */
.st8{fill:#b30000;}  /* Light gray for accents */

/* Gradient for metro body */
#metro-body {
  fill: url(#metro-gradient);
}
</style>
#bridge_1_{
.st0 { fill: none; stroke: black; stroke-miterlimit: 10; }
.st1 { fill: none; stroke: black; stroke-width: 0.93; stroke-miterlimit: 10; }
}
	#train_1_{
  .st2{fill:#ffcccc;}  /* White text */
	transform: translateX(-100%);
    -webkit-animation:linear infinite;
    -webkit-animation-name: run;
  ...
  <g class="layer">
    ...
    <g id="train_1_">
      ...
      <g id="svg_176">
        ...
        <line class="st6" id="svg_183" x1="425.1" x2="486" y1="5.2" y2="5.2"/>
        <path class="st5" d="m504.1,15.7c-1.8,-3.2 -4.5,-6 -7.6,-7.9l-0.6,0l0,0c-2.1,0 -3.8,1.7 -3.8,3.8l0,0.3l0,0c0,2.1 1.7,3.8 3.8,3.8l8.2,0z" id="svg_184"/>
        <text x="153" y="24" class="st2"  font-size="8" font-family="sans-serif">Patna Metro</text>
        <text x="403" y="24" class="st2"  font-size="8" font-family="sans-serif">Patna Metro</text>
      </g>
    </g>
  </g>
</svg>
